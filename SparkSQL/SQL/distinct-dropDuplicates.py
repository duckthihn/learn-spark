...
# jsonData.select(col("actor.id")).distinct().selectExpr()
jsonData.select(col("payload.forkee.public")).distinct().show()
jsonData.select(col("payload.forkee.public")).distinct().selectExpr("count(public) as count").show()
jsonData.select(col("payload.forkee.public")).distinct().selectExpr("count(*) as count").show()

jsonData.select(col("payload.forkee.public").alias("public")).dropDuplicates(["public"]).show()
